...
public class MainActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    EditText editTextCod, editTextName, editTextSalary;
    ...
    private boolean inputsAreCorrect(String cod, String name, String salary) {

        if (cod.isEmpty()) {
            editTextCod.setError("Please enter a code");
    ...
    private void addEmployee() {
        ...
        if (inputsAreCorrect(cod, name, salary))
        {
            String insertSQL = "INSERT INTO employees \n" +
                    "(cod, name, departament, joiningdate, salary)\n" +
                    "VALUES \n" +
                    "(?, ?, ?, ?, ?);";
           ...
           // mDatabase.execSQL(insertSQL, new String[]{cod, name, dept, joiningDate, salary});
            mDatabase.execSQL(insertSQL, new String[]{cod, name, dept, joiningDate, salary});
