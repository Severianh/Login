...
public class EmployeeAdapter extends ArrayAdapter<Employee> {
    ...
    public View getView(int position, @Nullable View convertView, @NonNull ViewGroup parent) {
        ...
        TextView textViewCod = view.findViewById(R.id.textViewCod);
        ...
        textViewCod.setText(employee.getCod());
    ...
    private void updateEmployee(final Employee employee) {
        ...
        final EditText editTextCod = view.findViewById(R.id.editTextCod);
        ...
        editTextCod.setText(employee.getCod());
        ...
        view.findViewById(R.id.buttonUpdateEmployee).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                String cod = editTextCod.getText().toString().trim();
                String name = editTextName.getText().toString().trim();
                String salary = editTextSalary.getText().toString().trim();
                String dept = spinnerDepartment.getSelectedItem().toString();

                if (cod.isEmpty()) {
                    editTextCod.setError("code can't be blank");
                ...
                mDatabase.execSQL(sql, new String[]{cod, name, dept, salary, String.valueOf(employee.getId())});
